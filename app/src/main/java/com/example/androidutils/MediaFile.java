...
public class MediaFile {
    ...
    public static final int FILE_TYPE_RMVB = 27;
    public static final int FILE_TYPE_FLV = 28;
    public static final int FILE_TYPE_F4V = 29;

    private static final int FIRST_VIDEO_FILE_TYPE = FILE_TYPE_MP4;
    private static final int LAST_VIDEO_FILE_TYPE = FILE_TYPE_F4V;
    ...
    static {
        ...
        addFileType("MKV", FILE_TYPE_MKV, "video/x-ms-mkv");
        addFileType("RMVB", FILE_TYPE_RMVB, "video/x-ms-rmvb");
        addFileType("FLV", FILE_TYPE_FLV, "video/x-ms-flv");
        addFileType("F4V", FILE_TYPE_F4V, "video/x-ms-f4v");
